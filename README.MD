...
### Matchup Predictions
The following table lists the matchups, and the predicted chance for team 1 to win (0.46 corresponds to 46%). This is for week 7 of 2022/23.
<table border="1" class="dataframe">
  <thead>
